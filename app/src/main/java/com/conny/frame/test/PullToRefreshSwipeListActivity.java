...
import com.conny.frame.test.adapters.PackageAdapter;
import com.conny.frame.test.adapters.PackageItem;
import com.conny.library.swiperefresh.BaseSwipeListViewListener;
import com.conny.library.swiperefresh.PullToRefreshBase;
import com.conny.library.swiperefresh.PullToRefreshSwipeListView;
import com.conny.library.swiperefresh.SwipeListView;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case MENU_DISABLE_SCROLL:
                ...
                break;
            case MENU_SET_MODE:
                mPullToRefreshSwipeListView.setMode(mPullToRefreshSwipeListView.getMode() == PullToRefreshBase.Mode.BOTH ? PullToRefreshBase.Mode.PULL_FROM_START
...
//            data.clear();
    ...
    private List<PackageItem> getItems() {
        List<PackageItem> items = new ArrayList<>();
        PackageItem item = new PackageItem();
        item.setName("11111-name");
        item.setPackageName("111111-package");

        PackageItem item1 = new PackageItem();
        item1.setName("22222-name");
        item1.setPackageName("222222-package");

        PackageItem item2 = new PackageItem();
        item2.setName("33333-name");
        item2.setPackageName("333333-package");

        PackageItem item3 = new PackageItem();
        item3.setName("44444-name");
        item3.setPackageName("444444-package");

        PackageItem item4 = new PackageItem();
        item4.setName("55555-name");
        item4.setPackageName("555555-package");
